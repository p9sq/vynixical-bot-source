        ...
        message.channel.send(embed)
            ...
            leavetxt.findOne({ guildID: message.guild.id } , ( err , lt ) => {
                if(!lt){
                    ...
                    newMSG.save();
                    message.channel.send(`<:allow:793205689753010217> **Successfully set the leave message to ${msg}**`)
                }else {
                    lt.msg = msg
                    lt.save()
                    message.channel.send(`<:allow:793205689753010217> **Successfully set the leave message to ${msg}**`)
...
module.exports.config = {
    ...
    category: "Config",
    example: "leavemsg It's sad to hear, but a member has just left the server :cry:",
    accessableby: "Admins",

...
module.exports.run = async (bot, message, args) => {
  const user = message.mentions.users.last() || message.author || bot.users.cache.get(args[0]);
  ...
  const embed = new Discord.MessageEmbed()
      ...
      .addField("User", [
         ...
         `**Avatar:** [Link to avatar](${user.displayAvatarURL({format: "png", dynamic: true, size: 2048})})`,
      ...
      .setFooter("User info", member.user.displayAvatarURL({format: "png", size: 2048, dynamic: true}))
      .setTimestamp()

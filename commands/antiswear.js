    ...
    if(!message.member.hasPermission("MANAGE_GUILD")) {
        ...
        antiswear.findOne({ guildID: message.guild.id} , (err, anti) => {
            if(!anti) {
                ...
                newConfig.save();
                message.channel.send(`<:allow:793205689753010217> **Anti-swearing has now been enabled**`)
            } else {
                message.channel.send("<:deny:793205689488900136> **Anti-swearing is already off**")
            }
        })
    }
}

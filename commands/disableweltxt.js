  ...
  if (!message.member.hasPermission("MANAGE_GUILD")) {
    ...
    weltxt.findOneAndDelete({ guildID: message.guild.id }, (err, wt) => {
      message.channel.send(
        "<:allow:793205689753010217> **Successfully reset the welcome message back to** `Welcome **{member}**, you are member number **{memberCount}**! I hope you have a great time in **{guild}**!`"
      );
    });
  }
};

...
module.exports.run = async (bot, message, args) => {
  const msg = await message.reply("<a:Issue:748716275705839786> | Pinging...", { allowedMentions: { repliedUser: false }});
...
module.exports.config = {
  name: "ping",
  description:
    "Shows the message edit speed, websocket lantency, your ping, and the bots shards",
  usage: "ping",
  category: "Fun",
  example: "ping",

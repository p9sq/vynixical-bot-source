    ...
    weltxt.findOne({ guildID: message.guild.id }, (err, wt) => {
      if (!wt) {
        ...
        message.channel.send(
          `<:allow:793205689753010217> **Successfully set the welcome message to ${msg}**`
        );
      } else {
        wt.msg = msg;
        wt.save();
...
module.exports.config = {
  ...
  category: "Config",
  example:
    "welmsg Hey there, welcome to the server, please go to #rules to read all rules to never be punished!",
  accessableby: "Admins",
